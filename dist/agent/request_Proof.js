...
exports.requestSimpleAttributeProof = requestSimpleAttributeProof;
// simple-attribute-proof.ts
const agent_1 = require("./agent");
async function requestSimpleAttributeProof(connectionId, fieldName = "gender") {
    ...
    const proofRequest = {
        ...
        autoAcceptProof: 'always' // ✅ Fixed: lowercase 'p'
    };
...
async function monitorProof(proofId, fieldName) {
    const agent = (0, agent_1.getAgent)();
...
//# sourceMappingURL=request_Proof.js.map